# Teaching and values of Solomon
...
- Astfel, cultura e transmisă lesne și e ușor de înțeles pentru cei care vor să fie drepți, precum un cântec (sound of wisdom) :VersePopup{book="Proverbs" numbers="2:6-7"}, :VersePopup{book="Proverbs" numbers="2:21-22"}
...
**Nu te speria** nici de situatii spontane nici de rezultatele celor wicked (societăți construite de corupți în putere, criminali, dezastre naturale sau economice). Înțeleg să nu îți iei deciziile in frică de ei. :VersePopup{book="Proverbs" numbers="3:25-26"}. **Fi sigur pe educatia ta** :VersePopup{book="Proverbs" numbers="4:11-12"}
...
**Tine inima curata** 
- Nu iti imbuiba ganduriile cu vorbe de la oamenii froward sau perversi :VersePopup{book="Proverbs" numbers="4:24"}
- Nu asculta de oamenii cruzi :VersePopup{book="Proverbs" numbers="5:9"}

**Nu da munca ta la străini** :VersePopup{book="Proverbs" numbers="5:10"} :VersePopup{book="Proverbs" numbers="5:15-17"}

**Platește o datorie cu tot efortul tău cât mai rapid** :VersePopup{book="Proverbs" numbers="6:1-5"} 
...
- **Cunoaștere**: acumularea informațiilor
    - Toate resursele tale de exploatare trebuie sa fie focusate pe acumularea informatiilor :VersePopup{book="Proverbs" numbers="4:7"}
...
- **Drept, just**
    - Prin natura dreptatea adevarata ghideaza, atrage?, transforma in perfect :VersePopup{book="Proverbs" numbers="4:18"}
    - Keep your heart clean. (se above)
- **Hotărâre**
    - Avansează in cea ce faci fără alte distrageri :VersePopup{book="Proverbs" numbers="4:25"}, :VersePopup{book="Proverbs" numbers="4:27"}
- **Organizare si pregatire** :VersePopup{book="Proverbs" numbers="4:26"}
- **Onoare** :VersePopup{book="Proverbs" numbers="5:9"} Nu stiu, probabil nu-ți risca reputația pentru alții?

## Anti-valori
**Definitii si caracteristici**
- Wicked (rautate din degenerare): Dupa definiție, se referă la cei care fac rău pentru că au o morală greșită. (Politicieni corupti, criminali saraci, membri de culturi teroriste, posadisti)
...
- Froward (archaic, literary) Disobedient, contrary, unmanageable; difficult to deal with; with an evil disposition. Probabil genul de oameni nervosi, dusmanosi, cu care te intelegi greu.
- Perverse (Turned aside while against something, splitting off from a thing.) - wikitionary
- Things that Lords hate:
    - Privire mandra (probabil sa privesti de sus) :VersePopup{book="Proverbs" numbers="5:6:16-17"}
    - Limba mincinoasa (deci nu o minciuna in sine, probabil tipologia de om dependent de minciuna, care e predispus sa o faca regulat)
    - Maini care au varsat sange inocent (o singura data e de ajuns sa fi demn de ura)
    - Inima care simte nevoia sa planifice degenerare (wicked) :VersePopup{book="Proverbs" numbers="6:18"} 
    - Picioare care se grabesc sa alerge catre faradelege (mischef)
    - Un martor mincinos
